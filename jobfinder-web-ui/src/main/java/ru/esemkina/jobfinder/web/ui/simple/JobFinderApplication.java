...
package ru.esemkina.jobfinder.web.ui.simple;
...
@ComponentScan
public class JobFinderApplication extends SpringBootServletInitializer {
    ...
    @Bean
    public ClientManager clientManagerCreator() {
